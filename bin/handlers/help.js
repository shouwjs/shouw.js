	...
	if (!args || args.length === 0) {
		...
		switch (command) {
			...
			case "?":
				...
				log("Description:");
				log(
					"  Displays helpful information about available commands and their usage.",
				);
				log(
					"  If a command is provided, shows details for that specific command.",
				);
				break;
			...
			case "create":
				...
				log("Description:");
				log(
					"  Scaffolds a new Shouw.js project with default files and configurations.",
				);
				break;
			...
			default:
				...
				log(
					'Use "shouw help" to view a list of supported commands and usage examples.',
				);
		}
	}
